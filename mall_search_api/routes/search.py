...
from mall_search_api.clients.elasticsearch_client import es_client
from mall_search_api.config import (
...
bp = Blueprint("mall_search", __name__)
...
@bp.route("/api/mall_search", methods=["POST"])
@log_api_call
def mall_search_api():
    try:
...
# =================== EXISTING HELPER FUNCTIONS (UNCHANGED) ===================
@bp.route("/api/mall_autosuggest", methods=["POST"])
@log_api_call
